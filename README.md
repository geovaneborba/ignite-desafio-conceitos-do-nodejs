...
<h1 align="center">Ignite | Trilha NodeJS: Desafio 01 - Conceitos do Node.js</h1>
...
## :dart: Sobre
  ...
  O desafio proposto foi criar uma aplicação para gerenciar tarefas (em inglês *todos*). 
  Essa aplicação deve ser permitida a criação de um usuário com `name` e `username`, bem como fazer o CRUD de *todos*:
  - Criar um novo *todo*;
...
[💻 Template do Desafio](https://github.com/rocketseat-education/ignite-template-conceitos-do-nodejs)
...
$ git clone https://github.com/geovaneborba/ignite-desafio-conceitos-do-nodejs
